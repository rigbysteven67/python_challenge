...
udemy_csv = os.path.join(r"C:\Users\Steven\gwu-arl-data-pt-09-2020-u-c\02-Homework\03-Python\01-Mini-Assignment\2.11-HW_UdemyZip\Resources", "web_starter.csv")
...
output_file = os.path.join(r"C:\Users\Steven\Homework\python_challenge\Minis", "udemy_final.csv")
